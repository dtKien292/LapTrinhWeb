...
public class add extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String phantram_raw = request.getParameter("phantram");
        Double phantram;
        DAO d = new DAO();
        vatTu a = d.searchVatTuByMa(mavtu);
        if(a==null){
            try {
                phantram = Double.parseDouble(phantram_raw);
                vatTu anew = new vatTu(mavtu, tenvtu, dvtinh, phantram);
                d.insert(anew);
            ...
            request.setAttribute("er", "đã tồn tại!!!");
